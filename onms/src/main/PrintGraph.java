		...
		public int print(Graphics g, PageFormat format, int pagenum)
		{
					...
					&& InventoryData.getCanTransformedDataFromFile().size() != 0)
			{
				...
				for (int i = 0; i < length; i++)
				{
					...
					yData[i] = (-1) * (float) (((Double) (InventoryData.getCanTransformedDataFromFile().get(i)))
								.doubleValue() / yScale);
				...
				d.translate(10, (int) format.getImageableHeight() / 2 - (int) format.getImageableHeight() / 4 - 60);
					...
					&& InventoryData.getXDataFromPortLength() != 0)
			{
				...
				for (int i = 0; i < length; i++)
				{
					...
					yData[i] = (-1) * (float) (((Double) (InventoryData.getCanTransformedDataFromPort().get(i)))
								.doubleValue() / yScale);
